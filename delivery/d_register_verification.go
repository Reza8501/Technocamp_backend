...
func (d *delivery) RegisterVerification(c *gin.Context) {
	var query dto.QueryParamRegisterVerification
	errBind := c.ShouldBindQuery(&query)
	...
	result := d.use.RegisterVerification(c.Request.Context(), query.Email)
