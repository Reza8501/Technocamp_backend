...
func (d *delivery) ProofTransaction(c *gin.Context) {
	var req dto.RequestProofTransaction
	...
	result := d.use.ProofTransaction(c.Request.Context(), req, userInfo["id"].(string))
